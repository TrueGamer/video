...
public class ApiAllUserTaskList extends BaseApi<List<TaskTitleBean>> {

    HashMap<String,String> mParamsMap = new HashMap<String,String>();

    public static final String from_uid="from_uid";

    public ApiAllUserTaskList(HttpOnNextListener listener, RxAppCompatActivity rxAppCompatActivity, HashMap<String,String> paramsMap) {
    ...
    public Observable getObservable(Retrofit retrofit) {
        return retrofit.create(ApiServices.class).getNewAllTask(mParamsMap);
    }
}
