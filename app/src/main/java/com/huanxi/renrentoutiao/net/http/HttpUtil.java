...
import com.huanxi.renrentoutiao.model.bean.l_video.TxLocationBean;
import com.huanxi.renrentoutiao.model.bean.l_video.TxLocationPoiBean;
import com.huanxi.renrentoutiao.ui.view.video.FollowEvent;
import com.huanxi.renrentoutiao.ui.view.video.NeedRefreshEvent;
import com.huanxi.renrentoutiao.utils.MD5Util;
...
public class HttpUtil {
    ...
    private static final String HTTP_URL_VIDEO = AppConfig.VIDEO_HOST + "/";
...
//        builder.addInterceptor(loggingInterceptor);
    ...
    public static void uploadFile(File file, HttpCallback callback) {
        OkGo.<JsonBean>post(HTTP_URL_VIDEO + UPLOAD_FILE)
                .headers("Connection", CONNECTION)
                .isMultipart(true)
                .params("picname", file)
                .tag(UPLOAD_FILE)
