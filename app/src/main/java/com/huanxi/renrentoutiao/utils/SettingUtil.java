...
public class SettingUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(MyApplication.mContext);
    ...
    public boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtil.isMobileConnected(MyApplication.mContext);
    }
     ...
     */
    public int getColor() {
        int defaultColor = MyApplication.mContext.getResources().getColor(R.color.colorPrimary);
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetWorkUtil.isWifiConnected(MyApplication.mContext);
    }
