...
public class HomeTabFragmentAdapter extends BaseMultiItemQuickAdapter<NewsItemBean, BaseViewHolder> {
     ...
     */
    public HomeTabFragmentAdapter(BaseActivity activity, List<NewsItemBean> data) {
        super(data);
        mActivity = activity;
        ...
        addItemType(NewsItemBean.BAIDU_AD , R.layout.item_baidu_ad_layout);
        ...
        helper.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ("contentbyhtml".equals(item.getQmttcontenttype())) {
                    ...
                    mActivity.startActivity(NewsDetailActivity2.getIntent(mActivity,item.getUrl()
                            ,item.getUrlmd5() , "xiaohua" , 1));
                }
            }
        });
    }
