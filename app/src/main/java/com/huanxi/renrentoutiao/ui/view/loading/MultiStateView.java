package com.huanxi.renrentoutiao.ui.view.loading;
...
import com.huanxi.renrentoutiao.utils.frameAnimationUtils.AnimationsContainer;
...
public class MultiStateView extends FrameLayout {
    ...
    public void setViewState(int state) {
        ...
        if (state != mCurrentState) {
            ...
            if (mProgressDialogAnim != null) {
                mProgressDialogAnim.stop();
            }
            ...
            if (view != null) {
                ...
                //这里我们做一个操作；
                if (state == STATE_LOADING) {
                    //这里我们找到我们的ImageView进行一个帧动画的播放；
                    /*ImageView imageView = (ImageView) view.findViewById(R.id.iv_loading);
                    mProgressDialogAnim = AnimationsContainer.getInstance(R.array.loading_anim, 24).createProgressDialogAnim(imageView);
                    mProgressDialogAnim.start();*/
                }
                addView(view);
                if (state == STATE_FAIL) {
