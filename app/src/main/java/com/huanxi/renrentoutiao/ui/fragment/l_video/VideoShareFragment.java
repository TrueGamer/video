...
import com.huanxi.renrentoutiao.interfaces.CommonCallback;
...
import com.huanxi.renrentoutiao.model.bean.l_video.ShareBean;
...
import com.huanxi.renrentoutiao.ui.adapter.l_video.VideoShareAdapter;
import com.huanxi.renrentoutiao.ui.view.video.ImageTextView;
import com.huanxi.renrentoutiao.ui.view.video.VideoDeleteEvent;
import com.huanxi.renrentoutiao.utils.DialogUitl;
import com.huanxi.renrentoutiao.utils.DownloadUtil;
import com.huanxi.renrentoutiao.utils.SharedSdkUitl;
...
//                startActivity(intent);
    ...
    private void copy() {
        if (mVideoBean != null) {
            ...
            ClipData clipData = ClipData.newPlainText("text", mConfigBean.getApp_android());
