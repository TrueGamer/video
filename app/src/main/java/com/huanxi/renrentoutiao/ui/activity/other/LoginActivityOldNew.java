    ...
    public void weChatLogin(final HashMap<String, String> paramsMap) {
        ...
        ApiWeChatLogin apiWeChatLogin = new ApiWeChatLogin(new HttpOnNextListener<String>() {
            ...
            public void onNext(String userBeanStr) {
                ...
                //这里设置别名；
                JPushInterface.setAlias(LoginActivityOldNew.this, ((int) System.currentTimeMillis()),userBean.getUserinfo().getUserid());
                ...
                if (userBean.getHasbind() == 0) {
                    ...
                    startActivityForResult(BindPhoneNumberActivity.getIntent(LoginActivityOldNew.this, paramsMap), REQUEST_BIND_NUMBER);
                } else {
                    //这里表示登陆成功；
        ...
        }, LoginActivityOldNew.this, paramsMap);
    ...
    private void doShowAddPhoneNumber(final HashMap<String, String> paramsMap) {
        ...
        tvSendCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //发送短信的一个方法；
                ApiSMSSend.defaultSend(LoginActivityOldNew.this, tvSendCode, trim, ApiSMSSend.BIND_PHONE_CODE);
            }
        });
